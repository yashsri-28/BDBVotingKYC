...
// //                 </div>
// //                 <p className="text-[11px] text-slate-400">Elections Management Application</p>
// //               </div>
// //             </div>
...
//   return (
//     <header className="sticky top-0 z-40 flex flex-col border-b border-slate-200 bg-white shadow-sm">
...
//             <div className="flex h-12 items-center justify-center mr-2">
//               <img src="./images/bdb-mainlogo.svg" alt="BDB" className="h-full w-full object-contain" />
//             </div>
//             <div>
//               <span className="text-base font-bold tracking-tight text-slate-700">BDB Voting</span>
...
//           {/* Right Side: FY Selector & User Info */}
//           <div className="flex items-center space-x-6">
//             <div className="hidden lg:flex items-center rounded-lg border border-blue-100 bg-blue-50 p-1">
//               <span className="flex items-center space-x-1 px-2 text-xs font-semibold text-[#083d77]">
//                 <span>FY:</span>
//               </span>
//               <select
//                 value={year}
//                 onChange={handleYearChange}
//                 className="rounded-md border border-blue-200 bg-white px-2.5 py-1 text-xs font-bold text-[#083d77] outline-none"
//               >
//                 {FY_OPTIONS.map((o) => <option key={o.value} value={o.value}>{o.label}</option>)}
//               </select>
//             </div>
...
//               <button
//                 onClick={handleSignOut}
//                 className="ml-2 flex items-center space-x-1.5 rounded-lg border border-blue-600 bg-blue-700 px-3 py-1.5 text-xs font-bold text-white transition-all hover:bg-rose-50 hover:text-rose-700 hover:border-rose-700"
//               >
//                 <span className="hidden md:inline">Logout</span>
//               </button>
//             </div>
...
//       {isArchiveYear && (
//         <div className="flex items-center justify-center space-x-2 border-y border-amber-500/30 bg-amber-500/10 px-4 py-1.5 text-center text-xs font-semibold text-amber-600">
//           <span>READ-ONLY ARCHIVE MODE — Viewing historical records for FY {year}. Modifications are disabled.</span>
//         </div>
//       )}
//     </header>
...
export default function TopBar({ toggleSidebar }) {
  ...
  return (
    <header className="sticky top-0 z-40 flex flex-col border-b border-slate-200 bg-white shadow-sm transition-all duration-300">
        ...
        <div className="flex h-18 items-center justify-between py-2">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="rounded-md text-slate-600 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-[#083d77] focus:ring-opacity-50 transition-colors mr-1"
